 ...
 * @author DUNCAN
 */
public class M_Account_create extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //dispatch
        this.getServletContext().getRequestDispatcher(common.URLConfig.JURLm_signUp).forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (isSafeToCommit){
            try{
                rUser.setRole(common.RolesConfig.Officer);
                rUser.commitChange();
                isCommitted = true;
            }
            catch(Exception e){
        ...
        if (isCommitted){
            response.sendRedirect(common.URLConfig.getFullPath(common.URLConfig.SURLm_signUp));
        }
        else{
