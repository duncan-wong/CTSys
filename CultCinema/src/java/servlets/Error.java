...
public class Error extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        beans.RError rError = new beans.RError();
        
        //redirect to index if /error is triggered without error code
        if (request.getParameter("errorCode") == null){
            ...
            this.getServletContext().getRequestDispatcher(common.URLConfig.JURL_error).forward(request, response);
        }
    }
