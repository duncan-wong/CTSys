            ...
            <div id="content" class="defaultWidth">
                ...
                <div class="formInfoContainer">
                    <c:if test="${rBookingCol.count == 0}">
                        <span class="infoLabel">No refund request</span>
                    </c:if>
                    <c:forEach items="${rBookingCol.allBooking}" var="booking">
                        ...
                        <div class="formInfoControl border_bottom">
                            ...
                            <span class="infoLabel span2">${movie.movieName}</span>
                            ...
                            <c:if test="${booking.isRefundPending}">
                                <a class="btn noLanguageOption" href="refundApproved?bid=${booking.bookingID}">Approve Refund</a>
                                <a class="btn noLanguageOption" href="refundDeclined?bid=${booking.bookingID}">Declined Refund</a>
                            </c:if>
                        </div>        
                    </c:forEach>
                </div>
